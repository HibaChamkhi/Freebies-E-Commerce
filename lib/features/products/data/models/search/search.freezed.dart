...
class _$SearchModelImpl implements _SearchModel {
  const _$SearchModelImpl({this.id, required this.text});
  ...
  @override
  String toString() {
    return 'SearchModel(id: $id, text: $text)';
  }
...
abstract class _SearchModel implements SearchModel {
  const factory _SearchModel({final int? id, required final String text}) =
      _$SearchModelImpl;
